...
python extract_training_features.py -k 5 -r 2000 3000 --save-originals --kernel $KERNEL --radius $RADIUS training $DIR/testing-feat.npz
...
python train_def_coefs.py -l 100 --rho 1.0 -n 12 -b 0.005 $DIR/training-feat.npz $DIR/mixtures.npz $DIR/coefs.npz
