...
def main():
    ...
    if inspect_component is not None:
        ...
        features = ag.features.bedges(digit, radius=inflate, k=bedges_k, first_axis=True)
        ...
        testing_edges = ag.features.bedges(testing_digits, radius=inflate, k=bedges_k, first_axis=True)
